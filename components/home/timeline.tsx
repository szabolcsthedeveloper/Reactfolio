...
const svgColor = "#111827";
const animColor = "#2563eb";
...
const TimelineSection = ({ isDesktop }: IDesktop) => {
  ...
  const addText = (
    ...
    const subtitleString = subtitle
      ? `<p class='text-xl mt-2 text-gray-700 font-medium tracking-wide'>${subtitle}</p>`
      : "";
  ...
  const renderSectionTitle = (): React.ReactNode => (
    <div className="flex flex-col">
      <h1 className="section-heading seq mt-2">WORK HISTORY</h1>
      <h2 className="text-2xl md:max-w-2xl w-full seq mt-2">
        Highlighting Memorable Achievements
      </h2>
    </div>
  );
